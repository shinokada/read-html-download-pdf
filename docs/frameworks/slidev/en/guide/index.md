...
- 🧑‍💻 [**Developer Friendly**](guide/syntax.html.html) - built-in syntax highlighting, live coding, etc.
- 🎨 [**Themable**](themes/gallery.html) - theme can be shared and used with npm packages
- 🌈 [**Stylish**](guide/syntax.html.html) - on-demand utilities via [Windi CSS](https://windicss.org/) or [UnoCSS](https://github.com/unocss/unocss).
- 🤹 [**Interactive**](custom/directory-structure.html.html) - embedding Vue components seamlessly
- 🎙 [**Presenter Mode**](guide/presenter-mode.html) - use another window, or even your phone to control your slides
- 🎨 [**Drawing**](guide/drawing.html) - draw and annotate on your slides
- 🧮 [**LaTeX**](guide/syntax.html.html) - built-in LaTeX math equations support
- 📰 [**Diagrams**](guide/syntax.html.html) - creates diagrams with textual descriptions 
- 🌟 [**Icons**](guide/syntax.html.html) - Access to icons from any iconset directly
