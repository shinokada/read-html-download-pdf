...
With the setup, you can provide the custom setting for shortcuts mentioned in [Navigation](guide/navigation.html) The above configuration binds next animation or slide to <kbd>enter</kbd> and previous animation or slide to <kbd>backspace</kbd>.
