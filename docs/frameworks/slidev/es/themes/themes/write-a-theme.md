...
Un tema puede proporcionar por defecto [configuraciones](custom/.html) vía `package.json`.
...
Aprende más sobre [las fuentes](custom/fonts) y [configuraciones de front matter](/custom/.html)
