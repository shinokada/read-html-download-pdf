...
Un thème peut fournir des [configurations par défaut](custom/.html) via `package.json`
...
En savoir plus sur les [polices](custom/fonts) et sur les [configurations frontmatter](/custom/.html)
