...
在這些情況下我們應該使用 [React Fragment](./fragments.html) 將數個 element 組織在一起。
...
如果你的 Fragment tag 不需要任何 prop，你也可以使用[簡寫語法](./fragments.html#short-syntax)，如果你的工具支援這個語法的話：
...
請參考 [Fragment 文件](./fragments.html)了解更多詳情。
