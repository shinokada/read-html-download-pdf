...
JSX jest tłumaczony jeden do jednego na reactowe "elementy". Sposoby ich wyświetlania na stronie poznamy w [następnym rozdziale](./rendering-elements.html). Poniżej znajdziesz podstawy składni JSX, które pozwolą ci szybko zacząć tworzyć kod.
...
Więcej o wyświetlaniu elementów reactowych dowiesz się w [następnym rozdziale](./rendering-elements.html).
