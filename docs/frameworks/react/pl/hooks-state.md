...
We [wstępie](./hooks-intro.html) przedstawiliśmy hooki za pomocą następującego przykładu:
...
>Uwaga
>
>Istnieje kilka specjalnych zasad, które mówią o tym kiedy możesz, a kiedy nie możesz używać hooków w komponencie. Więcej szczegółów poznamy w rozdziale pt. [„Zasady korzystania z hooków”](./hooks-rules.html).
...
W rozdziale pt. [„Hooki - FAQ”](./hooks-faq.html#should-i-use-one-or-many-state-variables) wypisaliśmy zalecenia dotyczące podziału niezależnych zmiennych stanu.
...
**Zapoznajmy się więc z [kolejnym hookiem: `useEffect`.](./hooks-effect.html)** Pozwala on na przeprowadzanie „efektów ubocznych” (ang. *side effects*) w komponentach i jest podobony do metod cyklu życia w klasach.
