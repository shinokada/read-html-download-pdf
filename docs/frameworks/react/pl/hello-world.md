...
nawigacji**. Przykładowo, rozdział pt. [“Wprowadzenie do JSX”](./introducing-jsx.html) jest
...
Kontynuuj przewijanie strony, aby dotrzeć do linku do [następnego rozdziału](./introducing-jsx.html).
