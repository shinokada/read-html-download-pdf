...
이 안내서의 모든 장들은 이전 장의 내용을 토대로 작성되었습니다. **사이드바에 보이는 순서대로 "주요 개념" 안내서의 장들을 읽으면 React의 거의 모든 내용을 익힐 수 있습니다.** [“JSX 소개”](./introducing-jsx.html)가 바로 이 다음 장입니다.
...
아래로 계속 스크롤하면, 푸터 바로 앞에서 [다음 장](./introducing-jsx.html)으로 연결된 링크를 찾을 수 있습니다.
