...
>
> Pour une introduction à React, consultez plutôt [Penser en React](./thinking-in-react.html).
...
[JSX](./introducing-jsx.html) joue un rôle similaire. Bien qu'il ne soit pas nécessaire à React, nous l'utilisons beaucoup chez Facebook à la fois pour des raisons esthétiques et pragmatiques.
