...
**Vous pouvez commencer à apprendre les Hooks [à la page suivante](./hooks-overview.html).** Dans celle-ci, nous vous expliquons pourquoi nous avons ajouté les Hooks à React et comment ils vous aideront à écrire des applications géniales.
...
Nous parlerons de ça plus en détail dans [Construire vos propres Hooks](./hooks-custom.html).
...
Nous verrons tout ça plus en détail dans [Utiliser le Hook d’effet](./hooks-effect.html#tip-use-multiple-effects-to-separate-concerns).
...
>Exemples
>
>[L’aperçu des Hooks](./hooks-overview.html) est un bon moyen de commencer à apprendre les Hooks.
...
Nous avons préparé une [FAQ des Hooks](./hooks-faq.html) qui répond aux questions les plus couramment posées sur les Hooks.

## Prochaines étapes {#next-steps}

Arrivé·e sur cette fin de page, vous devriez avoir une idée plus claire des problèmes résolus par les Hooks, mais de nombreux détails restent sans doute obscurs. Ne vous en faites pas ! **En route pour [la page suivante](./hooks-overview.html), dans laquelle nous commencerons à apprendre les Hooks par l'exemple.**
