...
> Use the [new context API](./context.html) introduced with version 16.3.
> The legacy API will continue working for all 16.x releases.

## How To Use Context {#how-to-use-context}

> This section documents a legacy API. See the [new API](./context.html).
...
If `contextTypes` is defined within a component, the following [lifecycle methods](./react-component.html#the-component-lifecycle) will receive an additional parameter, the `context` object:
