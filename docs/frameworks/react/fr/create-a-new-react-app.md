...
Si vous ne rencontrez pas les problèmes décrits ci-dessus ou si vous n'êtes pas encore à l'aise avec l'utilisation d'outils JavaScript, envisagez [d'ajouter React comme une simple balise `<script>` sur une page HTML](./add-react-to-a-website.html), éventuellement [avec du JSX](./add-react-to-a-website.html#optional-try-react-with-jsx).
...
- Si vous **apprenez React** ou **créez une nouvelle [application web monopage](./glossary.html#single-page-application)**, alors utilisez [Create React App](#create-react-app).
...
[Create React App](https://github.com/facebookincubator/create-react-app) est un environnement confortable pour **apprendre React**, et constitue la meilleure option pour démarrer **une nouvelle [application web monopage](./glossary.html#single-page-application)** en React.
...
Pensez à vous assurer que votre outillage personnalisé [est correctement configuré pour la production](./optimizing-performance.html#use-the-production-build).
