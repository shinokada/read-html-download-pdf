...
## [Elemente](./rendering-elements.html) {#elements}
...
## [Komponenten](./components-and-props.html) {#components}
...
Benutze refs sparsam. Wenn du dich da bei erwischst, refs in deiner Anwendung zu benutzen um "Dinge möglich zu machen", solltest du dich ein bisschen mehr mit dem [top-down Datenfluss](./lifting-state-up.html) auseinandersetzen.
...
## [Abgleich (reconciliation)](./reconciliation.html) {#reconciliation}
