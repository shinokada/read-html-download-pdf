...
Lies den [nächsten Abschnitt](./codebase-overview.html), um zu erfahren, wie die Codebase organisiert ist.<span style="float: footnote;"><a href="./index.html#toc">Go to TOC</a></span>
