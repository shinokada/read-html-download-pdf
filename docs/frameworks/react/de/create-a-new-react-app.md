...
Falls du die oben beschriebenen Probleme nicht kennst oder dich noch nicht bei der Benutzung von JavaScript Werkzeugen wohlfühlst, überlege, [React als einfachen `<script>` Tag einer HTML Seite hinzuzufügen](./add-react-to-a-website.html), optional [mit JSX](./add-react-to-a-website.html#optional-try-react-with-jsx).
...
- Wenn du **React lernst** oder **eine neue [Single Page](./glossary.html#single-page-application) Anwendung** erstellst, dann benutze [Create React App](#create-react-app).
...
[Create React App](https://github.com/facebookincubator/create-react-app) ist eine komfortable Umgebung, um **React zu lernen** und ist der beste Weg, mit **einer neuen [Single Page](./glossary.html#single-page-application) Anwendung** in React zu beginnen.
...
Vergiss nicht dafür zu sorgen, dass deine eigene Werkzeugkette [korrekt für die Produktionsumgebung aufgesetzt](./optimizing-performance.html#use-the-production-build) ist.
