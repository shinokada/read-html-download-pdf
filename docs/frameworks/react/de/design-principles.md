...
>
>For an introduction to React, check out [Thinking in React](./thinking-in-react.html) instead.
...
[JSX](./introducing-jsx.html) plays a similar role. While it is not required with React, we use it extensively at Facebook both for aesthetic and pragmatic reasons.
