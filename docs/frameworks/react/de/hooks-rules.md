...
* ✅ Hooks in eigenen Hooks aufrufen (Mehr dazu auf der [nächsten Seite](./hooks-custom.html)).
...
This plugin is included by default in [Create React App](./create-a-new-react-app.html#create-react-app).
...
**Du kannst den den Rest überspringen, wenn du direkt lernen möchtest wie man [seine eigenen Hooks](./hooks-custom.html) schreibt.** Im Folgenden werden die Gründe für die oben genannten Regeln noch genauer erläutert.

## Erklärung {#explanation}

Wie [zuvor erklärt](./hooks-state.html#tip-using-multiple-state-variables), können mehrere State- oder Effect-Hooks in einer Komponente verwendet werden.
...
Nun ist es Zeit zu lernen wie man [seine eigenen Hooks](./hooks-custom.html) schreibt. Das ist nützlich um State-behaftete Logik zwischen Komponenten zu teilen, wobei eigene Abstraktionen mit den von React bereitgestellten Hooks kombiniert werden können. 
