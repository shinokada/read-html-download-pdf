...
Die [Einführungsseite](./hooks-intro.html) verwendete dieses Beispiel um dir einen Ersteinblick in die Hooks zu bieten:
...
>Hinweis:
>
>Es gibt einige spezielle Regeln dafür, wo man innerhalb einer Komponente Hooks verwenden kann und wo nicht. Wir werden sie in [Regeln von Hooks](./hooks-rules.html) lernen.
...
Wir geben weitere Empfehlungen zur Aufteilung unabhängiger State-Variablen die du [in den FAQ](./hooks-faq.html#should-i-use-one-or-many-state-variables) nachlesen kannst.
...
**Fahren wir nun fort mit der [nächsten Hook: `useEffect`.](./hooks-effect.html)** Diese ermöglicht dir die Durchführung von Seiten-Effekten innerhalb von Komponenten und ähnelt den Lifecycle-Methoden in Klassen.
