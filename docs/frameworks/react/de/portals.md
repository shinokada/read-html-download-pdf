...
Das erste Argument (`child`) ist ein beliebiges [renderbares React-Kind](./react-component.html#render), wie beispielsweise ein Element, eine Zeichenkette oder ein Fragment. Das zweite Argument (`container`) ist ein DOM-Element.
...
> Hinweis:
>
> Wenn du mit Portalen arbeitest, denk daran, dass das [Verwalten des Tastaturfokus](./accessibility.html#programmatically-managing-focus) sehr wichtig wird.
>
