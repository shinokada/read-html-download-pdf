...
本指南中的每一章节都以其前述章节中介绍的知识点为基础。**你可以按照侧边导航栏中显示的顺序阅读浏览 “核心概念” 的指南章节。以了解 React 的大部分内容。** 例如，[“JSX 简介”](./introducing-jsx.html)就是本文的下一章节。
...
继续向下滚动，你将在网站页脚右侧找到[下一篇指南](./introducing-jsx.html)的链接。
