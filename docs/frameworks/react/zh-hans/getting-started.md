...
你可以[立即在 HTML 文件中添加 React](./add-react-to-a-website.html)，然后选择逐渐拓展它的应用范围，或只在一些动态小部件中使用它。

### 创建新的 React 应用 {#create-a-new-react-app}

当你刚开始一个 React 应用时，[通过 HTML 的 script 标签引入 React](./add-react-to-a-website.html) 依然是最好的选项，因为这能让你的项目立即启动。

但随着应用越来越大，你可能会需要更加集成化的安装方式。我们推荐了一些 JavaScript 工具链，它们适合大型应用。它们只需很少甚至零配置，就能让你充分利用丰富的 React 生态。[立即尝试](./create-a-new-react-app.html)。
...
* 如果你喜欢**一步步学习概念**，请从 [Hello World](./hello-world.html) 开始。
...
如果你喜欢**一步步学习概念**，我们的 [核心概念简介](./hello-world.html) 是最好的开始。指南里的每一章节都基于前一章节已学的内容，这样一步步过来你不会错过任何知识。

### React 哲学 {#thinking-in-react}

很多用户认为阅读 [React 哲学](./thinking-in-react.html)是他们最终对 React 恍然大悟的时刻。它可能是最老的 React 教程，但它依然极具价值。
...
一旦你已经熟知 React 的[主要概念](./hello-world.html)，并且已经在项目中小试牛刀，你可能会对更高级的话题感兴趣。该章节内容将会介绍一些强大但并不常用的 React 特性，比如：[context](./context.html) 和 [refs](./refs-and-the-dom.html)。

### API 参考 {#api-reference}

当你想深入学习特定 React API 细节时，该章节将会变得非常有用。举个例子：[`React.Component` API 参考](./react-component.html)能够介绍 `setState()` 方法是如何工作的，以及不同生命周期方法的使用场景。

### 术语表与常见问题 {#glossary-and-faq}

[术语表](./glossary.html)中包含了 React 文档中最常见术语的概览。常见问题章节致力于简短解答一些大家普遍遇到的问题，包括[发送 AJAX 请求](./faq-ajax.html)，[组件状态](./faq-state.html)以及[文件结构](./faq-structure.html) 等。
