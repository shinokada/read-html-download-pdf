...
**You can start learning Hooks [on the next page](./hooks-overview.html).** On this page, we'll continue by explaining why we're adding Hooks to React and how they can help you write great applications.
...
**If you just want to start learning Hooks, feel free to [jump directly to the next page!](./hooks-overview.html)** You can also keep reading this page to learn more about why we're adding Hooks, and how we're going to start using them without rewriting our applications.
...
We'll discuss this more in [Using the Effect Hook](./hooks-effect.html#tip-use-multiple-effects-to-separate-concerns).
...
>Examples
>
>[Hooks at a Glance](./hooks-overview.html) is a good place to start learning Hooks.
...
We've prepared a [Hooks FAQ page](./hooks-faq.html) that answers the most common questions about Hooks.

## Next Steps {#next-steps}

By the end of this page, you should have a rough idea of what problems Hooks are solving, but many details are probably unclear. Don't worry! **Let's now go to [the next page](./hooks-overview.html) where we start learning about Hooks by example.**
