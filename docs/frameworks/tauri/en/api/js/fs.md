...
| <div class=anchor-with-padding id=fs.BaseDirectory.Download><a href=#fs.BaseDirectory.Download>`Download`</a></div> | `8` | [fs.ts:88](https://github.com/tauri-apps/tauri/blob/527bd9f/tooling/api/src/fs.ts#L88) |
