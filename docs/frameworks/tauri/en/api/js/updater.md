...
**Defined in:** [updater.ts:34](https://github.com/tauri-apps/tauri/blob/527bd9f/tooling/api/src/updater.ts#L34)

##### `date`

>  **date**: `string`

**Defined in:** [updater.ts:33](https://github.com/tauri-apps/tauri/blob/527bd9f/tooling/api/src/updater.ts#L33)

##### `version`

>  **version**: `string`

**Defined in:** [updater.ts:32](https://github.com/tauri-apps/tauri/blob/527bd9f/tooling/api/src/updater.ts#L32)
...
**Defined in:** [updater.ts:41](https://github.com/tauri-apps/tauri/blob/527bd9f/tooling/api/src/updater.ts#L41)

##### `shouldUpdate`

>  **shouldUpdate**: `boolean`

**Defined in:** [updater.ts:42](https://github.com/tauri-apps/tauri/blob/527bd9f/tooling/api/src/updater.ts#L42)
...
**Defined in:** [updater.ts:24](https://github.com/tauri-apps/tauri/blob/527bd9f/tooling/api/src/updater.ts#L24)

##### `status`

>  **status**: [`UpdateStatus`](updater.md#updatestatus)

**Defined in:** [updater.ts:25](https://github.com/tauri-apps/tauri/blob/527bd9f/tooling/api/src/updater.ts#L25)
...
**Defined in:** [updater.ts:18](https://github.com/tauri-apps/tauri/blob/527bd9f/tooling/api/src/updater.ts#L18)
