...
Embeds, hashes, and compresses assets, including icons for the app as well as the system tray. Parses [`tauri.conf.json`](../../api/config.html) at compile time and generates the Config struct.
...
[Tauri Plugin Guide](../../guides/features/plugin.html)
...
[Development Cycle](../../guides/development/development-cycle.html)

[Publishing](../../guides/distribution/publishing.html)

[Updating](../../guides/distribution/updater.html)
