...
If you are upgrading to Nuxt v2.14 and want to use static hosting then you will need to add [`target:static`](./features/deployment-targets#static-hosting) to your nuxt.config.js file in order for the generate command to work properly.
