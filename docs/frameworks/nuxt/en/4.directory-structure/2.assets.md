...
#### Next
Learn more about [webpack Assets](./directory-structure/assets#webpack-assets)
...
#### Next
To add external fonts such as google fonts check out the [Meta Tags and SEO chapter](./features/meta-tags-seo#external-resources)
...
If you want to change the loader configurations, please use [build.extend](./configuration-glossary/configuration-build#extend).
