...
![](../../../../static/img/docs/nuxt-lifecycle.svg)
...
#### Info
Check out the component chapter to see more info on [`<NuxtLink>`](./features/nuxt-components#the-nuxtlink-component)
...
#### Next
Check out the [Features book](./features/rendering-modes)
