...
[propriété parseQuery / stringifyQuery](./configuration-glossary/configuration-router#parsequery--stringifyquery).
...
[propriété scrollBehavior](./configuration-glossary/configuration-router#scrollbehavior).
