...
![Les lifecycles de Nuxt 2.12](../docs/nuxt-lifecycle.svg)
...
Se référer au chapitre sur les composants pour plus d'informations sur [`<NuxtLink>`](./features/nuxt-components#the-nuxtlink-component).
...
Plus d'informations dans le [recueil sur les features](./features/rendering-modes).
