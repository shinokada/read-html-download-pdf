...
Plus d'informations pour les méthodes disponibles sont présents dans la documentation du [ModuleContainer](./internals-glossary/internals-module-container).
...
#### Info
Il y a beaucoup de hooks et de possibilités pour les modules. Se référer au [fonctionnement interne](./internals-glossary/internals) pour comprendre davantage l'API de Nuxt.
