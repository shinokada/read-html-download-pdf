...
利用可能なメソッドについては [ModuleContainer](./internals-glossary/internals-module-container) class のドキュメントを参照してください。
...
#### Info
モジュールにはもっと多くのフックと可能性があります。Nuxt 内部の API についての詳細は [Nuxt Internals](./internals-glossary/internals) を参照してください。
