...
このオプションは追跡したファイルが変更されていない場合にリビルドを避けるために `nuxt generate` の [static target](./features/deployment-targets#static-hosting) で使われます。
...
- **非推奨!**
- 代わりに [build.html.minify](./configuration-glossary/configuration-build#htmlminify) を使ってください
