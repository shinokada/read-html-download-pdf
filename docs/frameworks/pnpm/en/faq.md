...
If the store path is specified via [the store config](configuring.html) then copying
...
One of the solutions is to use [hooks](pnpmfile.html) for adding the missing
