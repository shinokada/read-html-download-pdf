...
When publishing a package inside a [workspace](../workspaces.html) the LICENSE file
...
You also can use the [`publishConfig.directory`](../package_json.html) to customize the published subdirectory (usually using third party build tools).
...
[publishConfig]: ../package_json.html)
