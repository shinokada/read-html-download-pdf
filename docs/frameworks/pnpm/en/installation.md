...
Do you wanna use pnpm on CI servers? See: [Continuous Integration](./continuous-integration.html)
...
Now that you know where the pnpm CLI is, open that directory and remove any pnpm-related files (`pnpm..html) `pnpx..html) `pnpm`, etc).
...
[Uninstalling pnpm](uninstall.html)
[pnpm env](cli/env.html)
